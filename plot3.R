...
plot3 <- function() {
    ...
    # abbreviated form, add the date_time column, generate plot #3, and save that plot to a plot3.png file.
    #
    ...
    ### Generate Plot 3 and save the plot to a PNG file with a width of 480 pixels and a height of 480 pixels.
